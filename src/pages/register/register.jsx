          ...
          <form className="form-body" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              ...
              <button
                ...
                className={`relative border rounded-xl px-5 py-4 text-left transition-all ${role === "guest"
              ...
              <button
                ...
                className={`relative border rounded-xl px-5 py-4 text-left transition-all ${role === "host"
                  ? "border-cyan-600 bg-cyan-50"
                  : "border-slate-300 bg-white hover:border-slate-400"
                  }`}
              >
